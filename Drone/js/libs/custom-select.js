class ItcCustomSelect {
    ...
    static template(params) {
      ...
      let selectedIndex = -1;
      let selectedValue = '';
      let selectedContent = getCookie('lang') || 'Укр';
      ...
      return `<button type="button" class="itc-select__toggle" name="${name}"
        ...
        <img class="lang-switcher__image" src="icons/lang-${selectedValue}.svg" alt="lang">${selectedContent}</button><div class="itc-select__dropdown">
    ...
    _updateOption(el) {
      ...
      this._elToggle.innerHTML = `<img class="lang-switcher__image" src="icons/lang-${elOption.dataset.value}.svg" alt="lang">${elOption.textContent}`;
    ...
    _reset() {
      ...
      let cookieLang;
      let cookieLangEdited;
      if (getCookie('lang')) {
        cookieLang = getCookie('lang');
        cookieLangEdited = getCookie('lang') === 'ua' ? 'Укр' : 'Eng';
      }

      this._elToggle.innerHTML = `<img class="lang-switcher__image" src="icons/lang-${cookieLang}.svg" alt="lang">${cookieLangEdited || 'Укр'}`;
