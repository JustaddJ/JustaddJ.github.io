...
function calc() {
  ...
  getDynamicInformation('#age'); // showSlides(slideIndex);
  // if (slides.length < 10) {
...
function forms(formSelector, modalTimerId) {
  ...
  const message = {
    ...
    succes: 'Спасибо! Мы свяжемся с вами в ближейшее время!',
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  //Modal
  const modalTriggerOpen = document.querySelectorAll(triggerSelector),
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2023-02-05');
